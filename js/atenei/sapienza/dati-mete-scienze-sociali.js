...
var METE = [
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Francese", livello: "B2", condizione: "per corsi Bachelor in francese" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Inglese", livello: "B2", condizione: "per corsi in inglese" },
        { lingua: "Francese", livello: "B2", condizione: "se il learning agreement contiene almeno un corso in francese" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Spagnolo", livello: "B1", condizione: "raccomandato per corsi di laurea; richiesto per alcuni programmi e per studi post-laurea nella lingua di insegnamento" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Spagnolo", livello: "B1", condizione: "raccomandato; prova del livello non richiesta" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    scadenzeOspitante: [
        ...
        { cosa: "Nomination (primavera)", periodo: "entro 30 dicembre" }
      ],
