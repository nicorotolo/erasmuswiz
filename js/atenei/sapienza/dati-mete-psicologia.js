...
var METE = [
  ...
  },
  {
    ...
    requisitoLingua: [
        ...
        { lingua: "Francese", livello: "C1", condizione: "per corsi di Modern Literature and Education" },
        { lingua: "Inglese", livello: "B2", condizione: "per corsi in inglese" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Tedesco", livello: "B2", condizione: "per studi o tirocinio in tedesco" },
        { lingua: "Inglese", livello: "B2", condizione: "per corsi in inglese" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination (autunno, studenti UE)", periodo: "entro 15 maggio" },
        { cosa: "Nomination (primavera, studenti UE)", periodo: "entro 15 novembre" },
        { cosa: "Application online (autunno)", periodo: "entro 30 maggio" },
        { cosa: "Application online (primavera)", periodo: "entro 30 novembre" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Tedesco", livello: "B1", condizione: "lingua di insegnamento" },
        { lingua: "Inglese", livello: "B2", condizione: "solo per il modulo di tirocinio in inglese" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [],
    notePratiche: "Posti totali dell'accordo: 2 (condivisi tra i livelli)."
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Tedesco", livello: "B2", condizione: "nella lingua del corso" },
        { lingua: "Inglese", livello: "B2", condizione: "nella lingua del corso" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Inglese", livello: "B1", condizione: "per studenti" },
        { lingua: "Portoghese", livello: "A2", condizione: "per studenti" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Portoghese", livello: "B1", condizione: "certificato richiesto agli studenti Erasmus" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination (autunno/anno intero)", periodo: "entro 15 maggio 2026" },
        { cosa: "Nomination (primavera)", periodo: "entro 30 ottobre 2026" },
        { cosa: "Application (autunno/anno intero)", periodo: "entro 31 maggio 2026" },
  ...
  },
  {
    ...
    scadenzeOspitante: [
        ...
        { cosa: "Application (autunno/anno intero)", periodo: "entro 20 giugno" },
        { cosa: "Nomination (primavera)", periodo: "entro 15 novembre" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Portoghese", livello: "B1", condizione: "per studenti in mobilita" },
        { lingua: "Inglese", livello: "B1", condizione: "per studenti in mobilita" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination (autunno/anno intero)", periodo: "entro 1 giugno 2026" },
        { cosa: "Nomination (primavera)", periodo: "entro 1 novembre 2026" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Portoghese", livello: "B1", condizione: "livello minimo raccomandato" },
        { lingua: "Inglese", livello: "B2", condizione: "livello minimo raccomandato" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        ...
        { cosa: "Application (autunno/anno intero)", periodo: "dal 1 marzo al 15 maggio" },
  ...
  },
  {
    ...
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination (autunno)", periodo: "entro 6 gennaio" },
        { cosa: "Nomination (primavera)", periodo: "entro 10 gennaio" },
        { cosa: "Application (autunno)", periodo: "entro 30 giugno" },
        { cosa: "Application (primavera)", periodo: "entro 30 ottobre" }
      ],
  ...
  },
  {
    ...
    notePratiche: "Posti totali dell'accordo: 1 (condivisi tra i livelli). || Scadenze: basate su 2024/25"
  },
  {
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Spagnolo", livello: "B1", condizione: "raccomandato per studenti di scambio" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination (autunno)", periodo: "entro 15 maggio" },
  ...
  },
  {
    ...
    scadenzeOspitante: [
        ...
        { cosa: "Application (autunno)", periodo: "dal 16 febbraio al 19 giugno 2026" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Spagnolo", livello: "B2", condizione: "raccomandato per studenti Erasmus undergraduate" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Application (autunno/anno intero)", periodo: "entro 30 giugno" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Spagnolo", livello: "B1", condizione: "per studenti Erasmus+ KA131; B2 per Medicina" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination (autunno/anno intero)", periodo: "entro 25 maggio" },
        { cosa: "Application (autunno/anno intero)", periodo: "entro 31 maggio" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Catalano", livello: "B1", condizione: "in base alla lingua di insegnamento degli esami scelti" },
        { lingua: "Spagnolo", livello: "B1", condizione: "in base alla lingua di insegnamento degli esami scelti" },
        { lingua: "Inglese", livello: "B1", condizione: "in base alla lingua di insegnamento degli esami scelti" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination (autunno/anno intero, Psicologia)", periodo: "entro 18 maggio 2026" },
        { cosa: "Application (autunno/anno intero, Psicologia)", periodo: "entro 1 giugno 2026" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Spagnolo", livello: "B1", condizione: "minimo richiesto; B2 raccomandato per corsi in spagnolo" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination/Application (autunno)", periodo: "dal 2 marzo al 30 giugno 2026" },
        { cosa: "Nomination/Application (primavera)", periodo: "dal 15 settembre al 29 novembre" }
      ],
    notePratiche: "Posti totali dell'accordo: 1 (condivisi tra i livelli). || Scadenze: basate su 2025/26"
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Spagnolo", livello: "A2", condizione: "raccomandato per corsi prevalentemente in spagnolo" },
        { lingua: "Spagnolo", livello: "B1", condizione: "puo' essere richiesto per tirocini pratici in area sanitaria" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Inglese", livello: "B1", condizione: "salvo diversa indicazione nell'accordo bilaterale" }
      ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
        { cosa: "Nomination (autunno)", periodo: "entro 15 luglio" },
  ...
  },
  {
    ...
    requisitoLingua: [
        { lingua: "Turco", livello: "B2", condizione: "per studiare presso l'universita" },
