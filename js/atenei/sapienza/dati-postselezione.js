...
var CHECKLIST_POST = [
  // ---- Accettazione ----
  { id: "sap-post-acc-1", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Accetta la sede in tempo (5-7 giorni)", momento: "quando accetti",
  ...
  { id: "sap-post-acc-2", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Tieni d'occhio l'email istituzionale", momento: "quando accetti",
  ...
  { id: "sap-post-acc-3", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Aspetta la nomina all'ateneo ospitante", momento: "dopo aver accettato",
    testo: "Attendi che l'ufficio Erasmus ti nomini all'università ospitante: è Sapienza a farlo, non tu." },
  { id: "sap-post-acc-4", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Fai l'application all'ateneo ospitante", momento: "dopo aver accettato",
  ...
  { id: "sap-post-acc-5", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Conserva la lettera di ammissione", momento: "dopo aver accettato",
    testo: "Conserva la lettera di ammissione dell'università ospitante: ti servirà prima della partenza." },

  // ---- Learning Agreement ----
  { id: "sap-post-la-1", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Cerca i corsi all'estero",
  ...
  { id: "sap-post-la-2", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Compila il LA e fallo approvare dal RAM",
  ...
  { id: "sap-post-la-3", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Firme: digitali o su PDF",
  ...
  { id: "sap-post-la-4", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Ogni modifica, approvata prima di partire",
    testo: "Fai approvare da RAM e università ospitante ogni modifica al Learning Agreement PRIMA della partenza." },
  { id: "sap-post-la-5", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Aggiorna il LA solo dalla pagina personale",
  ...
  { id: "sap-post-doc-1", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Approva il contratto online",
  ...
  { id: "sap-post-doc-2", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Aspetta la controfirma di Sapienza",
    testo: "Attendi l'email che ti avvisa della controfirma di Sapienza: solo dopo potrai inserire i dati bancari." },
  { id: "sap-post-doc-3", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Inserisci i dati bancari",
  ...
  { id: "sap-post-doc-4", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Rinnova l'iscrizione",
  ...
  { id: "sap-post-doc-5", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Test di lingua online (OLS)",
  ...
  { id: "sap-post-doc-6", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Documento valido per tutto il periodo",
    testo: "Verifica che carta d'identità o passaporto siano validi per tutto il periodo della mobilità." },
  { id: "sap-post-doc-7", fase: "Documenti pre-partenza", gruppoZaino: "Prima", condizionale: true, tipo: "condizione", titolo: "Cittadinanza extra-UE: informati presto",
  ...
  { id: "sap-post-doc-8", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Copertura sanitaria",
  ...
  { id: "sap-post-doc-9", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Registrati su Viaggiare Sicuri",
    testo: "Registra il soggiorno su viaggiaresicuri.it prima di partire." },

  // ---- Arrivo ----
  { id: "sap-post-arr-1", fase: "Arrivo", gruppoZaino: "Durante", titolo: "Carica la dichiarazione di arrivo",
  ...
  { id: "sap-post-arr-2", fase: "Arrivo", gruppoZaino: "Durante", condizionale: true, tipo: "avvertenza", titolo: "L'arrivo vale solo se hai fatto tre cose",
  ...
  { id: "sap-post-dur-1", fase: "Durante la permanenza", gruppoZaino: "Durante", condizionale: true, tipo: "opzione", titolo: "Cambi agli esami: Change Form",
  ...
  { id: "sap-post-dur-2", fase: "Durante la permanenza", gruppoZaino: "Durante", titolo: "Nomi degli esami identici",
  ...
  { id: "sap-post-dur-3", fase: "Durante la permanenza", gruppoZaino: "Durante", condizionale: true, tipo: "opzione", titolo: "Vuoi restare di più?",
  ...
  // ---- Rientro ----
  { id: "sap-post-rit-1", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Certificato di frequenza",
  ...
  { id: "sap-post-rit-2", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Transcript of Records al RAEF",
  ...
  { id: "sap-post-rit-3", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Controlla e trascrivi i voti",
  ...
  { id: "sap-post-rit-4", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Accetta la convalida del RAM",
    testo: "Accetta via email la proposta di convalida del RAM: è l'ultimo passo perché gli esami finiscano su Infostud." },
  { id: "sap-post-rit-5", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Convalida gli esami entro il termine",
  ...
  { id: "sap-post-rit-6", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Rapporto finale UE",
    testo: "Compila il rapporto narrativo (EU Survey) quando ricevi l'invito sull'email istituzionale." },
  { id: "sap-post-rit-7", fase: "Rientro", gruppoZaino: "Dopo", condizionale: true, tipo: "avvertenza", titolo: "Non laurearti prima della convalida",
