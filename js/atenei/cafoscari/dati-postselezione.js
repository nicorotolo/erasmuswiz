...
var CHECKLIST_POST = [
  // ---- Accettazione ----
  { id: "post-acc-1", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Accetta il posto in tempo", momento: "quando accetti",
  ...
  { id: "post-acc-5", fase: "Accettazione", gruppoZaino: "Prima", condizionale: true, tipo: "opzione", titolo: "Scegli il semestre di partenza", momento: "prima di accettare",
  ...
  { id: "post-acc-6", fase: "Accettazione", gruppoZaino: "Prima", condizionale: true, tipo: "avvertenza", titolo: "Se decidi di non partire", ultima: true,
  ...
  { id: "post-acc-2", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Tieni d'occhio l'email istituzionale", momento: "quando accetti",
  ...
  { id: "post-acc-3", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Aspetta la nomina all'ateneo ospitante", momento: "dopo aver accettato",
    testo: "Attendi che il Settore Mobilità ti nomini all'università ospitante: è Ca' Foscari a farlo, e te ne dà comunicazione." },
  { id: "post-acc-4", fase: "Accettazione", gruppoZaino: "Prima", titolo: "Fai l'application all'ateneo ospitante", momento: "dopo aver accettato",
  ...
  { id: "post-acc-7", fase: "Accettazione", gruppoZaino: "Prima", condizionale: true, tipo: "avvertenza", titolo: "L'ateneo ospitante può ancora dire no", momento: "dopo aver accettato",
  ...
  // ---- Learning Agreement ----
  { id: "post-la-1", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Cerca i corsi all'estero",
  ...
  { id: "post-la-2", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Concorda il piano col coordinatore",
  ...
  { id: "post-la-3", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Compila l'OLA e raccogli le firme",
  ...
  { id: "post-la-5", fase: "Learning Agreement", gruppoZaino: "Prima", titolo: "Controlla le propedeuticità",
  ...
  { id: "post-la-6", fase: "Learning Agreement", gruppoZaino: "Prima", condizionale: true, tipo: "avvertenza", titolo: "Niente esami parziali nell'OLA",
  ...
  { id: "post-la-4", fase: "Learning Agreement", gruppoZaino: "Prima", condizionale: true, tipo: "condizione", titolo: "Ricerca tesi: serve un LA in più",
  ...
  { id: "post-doc-1", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Documento valido per tutto il periodo",
    testo: "Verifica che carta d'identità o passaporto siano validi per tutto il periodo della mobilità." },
  { id: "post-doc-2", fase: "Documenti pre-partenza", gruppoZaino: "Prima", condizionale: true, tipo: "opzione", titolo: "Visto, se il paese lo chiede",
  ...
  { id: "post-doc-8", fase: "Documenti pre-partenza", gruppoZaino: "Prima", condizionale: true, tipo: "condizione", titolo: "Cittadinanza extra-UE: muoviti presto",
  ...
  { id: "post-doc-3", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Copertura sanitaria",
  ...
  { id: "post-doc-4", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Firma il contratto finanziario",
  ...
  { id: "post-doc-5", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Firma la liberatoria",
  ...
  { id: "post-doc-6", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Test di lingua online (OLS)",
  ...
  { id: "post-doc-7", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Registrati su Viaggiare Sicuri",
    testo: "Registrati su viaggiaresicuri.it e informati sullo stato di sicurezza della destinazione prima di partire." },
  { id: "post-doc-9", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Trova casa, presto",
  ...
  { id: "post-doc-10", fase: "Documenti pre-partenza", gruppoZaino: "Prima", titolo: "Continua a pagare le tasse a Ca' Foscari",
  ...
  // ---- Arrivo ----
  { id: "post-arr-1", fase: "Arrivo", gruppoZaino: "Durante", titolo: "Manda la conferma di arrivo (7 giorni)",
  ...
  { id: "post-arr-2", fase: "Arrivo", gruppoZaino: "Durante", condizionale: true, tipo: "opzione", titolo: "Cambi al piano: entro 30 giorni",
  ...
  { id: "post-dur-1", fase: "Durante la permanenza", gruppoZaino: "Durante", titolo: "Supera almeno un esame",
  ...
  { id: "post-dur-5", fase: "Durante la permanenza", gruppoZaino: "Durante", titolo: "Comunica solo via email",
  ...
  { id: "post-dur-2", fase: "Durante la permanenza", gruppoZaino: "Durante", condizionale: true, tipo: "opzione", titolo: "Tirocinio durante l'Erasmus",
  ...
  { id: "post-dur-3", fase: "Durante la permanenza", gruppoZaino: "Durante", condizionale: true, tipo: "opzione", titolo: "Vuoi restare di più?",
  ...
  { id: "post-dur-4", fase: "Durante la permanenza", gruppoZaino: "Durante", condizionale: true, tipo: "opzione", titolo: "Viaggio ecologico: contributo in più",
  ...
  // ---- Rientro ----
  { id: "post-rit-1", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Manda la conferma di partenza",
  ...
  { id: "post-rit-2", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Recupera il Transcript of Records",
  ...
  { id: "post-rit-4", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Riconoscimento dei crediti",
  ...
  { id: "post-rit-5", fase: "Rientro", gruppoZaino: "Dopo", condizionale: true, tipo: "avvertenza", titolo: "Le regole del riconoscimento",
  ...
  { id: "post-rit-6", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Invia tutto entro la scadenza",
  ...
  { id: "post-rit-3", fase: "Rientro", gruppoZaino: "Dopo", titolo: "Questionario finale UE",
  ...
  { id: "post-rit-7", fase: "Rientro", gruppoZaino: "Dopo", condizionale: true, tipo: "avvertenza", titolo: "Non laurearti prima del riconoscimento",
