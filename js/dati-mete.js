...
const METE = [
  ...
  },
  {
    ...
    requisitoLingua: [
      { lingua: "Inglese", livello: "B1", condizione: "certificato obbligatorio per seguire corsi in inglese alla Faculty of Business and Economics" }
    ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    requisitoLingua: [
      { lingua: "Inglese", livello: "B2", condizione: "per corsi in inglese; competenze linguistiche equivalenti almeno a B2 CEFR" }
    ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
  ...
  },
  {
    ...
    requisitoLingua: [
      { lingua: "Inglese", livello: "B2", condizione: "prova di conoscenza dell'inglese richiesta; livello non inferiore a B2 CEFR" }
    ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
    ...
    notePratiche: "Aperta a: CdS del Dipartimento di Economia e Laurea Magistrale in Relazioni internazionali comparate - [Dati ufficiali bando 2026/27] ciclo: L, LM; studenti: 6; mesi: 5. || Lingua: il sito VMU non indica un livello CEFR esplicito; disponibile supporto Online Language Support (OLS) - da verificare. Nomination via erasmus@vdu.lt. [Fonte: vdu.lt/en/international-cooperation] || Lingua: inglese B2 CEFR minimo richiesto tra i documenti di application. [Fonte: VMU Incoming students]"
  },
  {
  ...
  },
  {
    ...
    requisitoLingua: [
      { lingua: "Inglese", livello: "B2", condizione: "prova di conoscenza dell'inglese richiesta per exchange FEB" }
    ],
    prerequisiti: "Da verificare sulla scheda ufficiale della destinazione.",
    scadenzeOspitante: [
